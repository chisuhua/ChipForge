...
CHIPFORGE_TEST_REGEX='(test_(payload|pipe_node|pipe_builder|ctrl_link|hello_plugin|coexistence|plugin_lifecycle|mem_bundles|l1_cache_plugin_unit))|(verify_plugin_decision)'
