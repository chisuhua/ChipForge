...
### Requirement: ip/cpu/test/ exists as a test directory
**Reason**: All CPU tests live at `tests/cpu/` (the IP-internal `ip/cpu/test/` was always README-only and has been removed).
**Migration**: Update `ip/cpu/README.md` to reference `tests/cpu/` for the testing section.
