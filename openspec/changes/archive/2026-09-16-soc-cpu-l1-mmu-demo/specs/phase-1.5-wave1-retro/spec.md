# phase-1.5-wave1-retro Specification (lessons-learned)

> **Type**: NEW (lessons-learned, no production code)
> **Date**: 2026-09-15
> **Purpose**: Archive four deviations discovered during Phase 1.5 Wave 1 (`riscv-tests-rv32ui` v0.2.2) so that future sessions can reference them without re-debugging. This is documentation only — no source files are required to satisfy this spec.
