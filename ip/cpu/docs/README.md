...
| [status.md](status.md) | 任务状态看板 — 49 个 M1.x 任务粒度 PASS/FAIL/进度% | 项目管理者 | **高频** (每次 Mx.y 完成即更新) |
...
| [implementation-plan/M4-integration.md](implementation-plan/M4-integration.md) | M4 详细任务清单 (11 个子任务) | 实施者 | 任务粒度变化时 |
| [implementation-plan/M5-verification.md](implementation-plan/M5-verification.md) | M5 详细任务清单 (9 个子任务) | 实施者 | 任务粒度变化时 |
